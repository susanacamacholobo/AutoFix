...
class _MisIncidentesScreenState extends State<MisIncidentesScreen> {
  ...
  List<Map<String, dynamic>> _getPasos(dynamic incidente) {
    ...
    String subtituloTecnico = 'Estado actual';
    if (tieneTecnico && tiempoEstimado != null && tiempoEstimado['minutos'] != null) {
      subtituloTecnico = 'Llegada estimada: ${tiempoEstimado['minutos']} min (${tiempoEstimado['distancia_km']} km)';
    }
    ...
    return [
      {
        ...
        'completado': true,
        'esActual': !tieneResumen && !tieneTaller && !tieneTecnico && !atendido,
        'subtitulo': '',
      },
      {
        'icono': tieneResumen ? '✅' : '⏳',
        ...
        'subtitulo': !tieneResumen ? 'Analizando con IA...' : '',
      },
      {
        'icono': tieneTaller ? '🏪' : '🔍',
        ...
        'subtitulo': tieneResumen && !tieneTaller ? 'Buscando el taller más cercano...' : '',
      },
      {
        'icono': '👨‍🔧',
        ...
        'subtitulo': tieneTecnico && !atendido ? subtituloTecnico : '',
      },
      {
        'icono': '✅',
        ...
        'completado': atendido,
        'esActual': atendido,
        'subtitulo': atendido ? 'Servicio finalizado' : '',
      },
    ];
  }
                        ...
                        Column(
                          children: [
                            ...
                            if (!esUltimo)
                              Container(
                                width: 2, height: 40,
                                color: completado && (index + 1 < pasos.length && (pasos[index + 1]['completado'] as bool))
                                    ? const Color(0xFFE63946)
